      ...
      <div className="w-10/12 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {pricingData.map((plan) => (
            <div
              key={plan.id}
              className={`relative rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-2xl ${
                plan.isPopular
            ...
            >
              ...
              {/* Button */}
              <button
                className={`w-full font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg ${
                  plan.isPopular
